...
public class FileUtil {
    ...
    private void checkProjectDirectories() {
    ...
    private boolean checkFileDirectory(String absolutFolderPath) {
    ...
    public String readAssetFile(Context context, String path) {
    ...
    public boolean writeToFile(String absoluteFileName, String content)
    {
        try
        {
