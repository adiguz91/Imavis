...
public class DroneDeviceControllerListener {

    private final Handler mHandler;
    private DroneDeviceOnCommandReceivedListener commandReceivedListener;
    private final SDCardModule mSDCardModule;

    public DroneDeviceControllerListener(Context context, SDCardModule sdCardModule) {
        mHandler = new Handler(context.getMainLooper());
        mSDCardModule = sdCardModule;
        mSDCardModule.addListener(mSDCardModuleListener);
    }

    public void setListener(DroneDeviceOnCommandReceivedListener listener) {
    ...
    private final SDCardModule.Listener mSDCardModuleListener = new SDCardModule.Listener() {
        ...
        public void onMatchingMediasFound(final int nbMedias) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    commandReceivedListener.notifyMatchingMediasFoundChanged(nbMedias);
                }
            });
        }
        ...
        public void onDownloadProgressed(final String mediaName, final int progress) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    commandReceivedListener.notifyDownloadProgressedChanged(mediaName, progress);
                }
            });
        }
        ...
        public void onDownloadComplete(final String mediaName) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    commandReceivedListener.notifyDownloadCompleteChanged(mediaName);
                }
            });
        }
    };
    ...
    private final ARDeviceControllerListener mDeviceControllerListener = new ARDeviceControllerListener() {
        ...
        public void onStateChanged(ARDeviceController deviceController, ARCONTROLLER_DEVICE_STATE_ENUM newState, ARCONTROLLER_ERROR_ENUM error) {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    commandReceivedListener.notifyConnectionStateChanged(newState);
                }
            });
        }
            ...
            if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_BATTERYSTATECHANGED) && (elementDictionary != null)) {
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyBatteryProgressChanged(battery);
                        }
                    });
                }
            }
            if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_ARDRONE3_PILOTINGSETTINGSSTATE_MAXDISTANCECHANGED) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMaxDistanceChanged(current, min, max);
                        }
                    });
                }
            }
            if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_ARDRONE3_PILOTINGSTATE_MOVETOCHANGED) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMoveToChanged(new GPSCoordinate(latitude, longitude, altitude), heading,
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCurrentDateChanged(date); // waiting for time
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCurrentTimeChanged(time); // waiting for time
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyPictureAndVideoResolutionChanged(type); // waiting
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyPictureAndVideoFramerateChanged(framerate); // waiting
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyAutoVideoRecordStatusChanged(BooleanExtension.parse(enabled), massStorageId);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyReturnHomeDelayAfterDisconnectChanged(delay);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyHomeTypeChanged(type);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyReturnHomeOnDisconnectStatusChanged(BooleanExtension.parse(state), BooleanExtension.parse(isReadOnly));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyWifiSettingsCountryChanged(codeCountry);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyWifiSettingsAutoCountryStatusChanged(BooleanExtension.parse(automatic));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyWifiSecurityChanged(key, keyType);
                        }
                    });
                }
            }
            /*else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_ARDRONE3_PILOTINGSTATE_ALERTSTATECHANGED) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyVideoStreamingStatusChanged(enabledStatus);
                        }
                    });
                }
            }
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        commandReceivedListener.notifyMassStorageContentChanged(massContentTypeCount);
                    }
                });
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyReturnHomeStateChanged(state, reason);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            //mFlyingState = state;
                            commandReceivedListener.notifyFlyingStateChanged(state);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyPictureStateChanged(state, error);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyRecordVideoOrTakePicturesStateChanged(state, error);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyPictureTakenChanged(error);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            //mRunId = runId;
                            commandReceivedListener.notifyCurrentRunIdChanged(runId);
                        }
                    });
                }
            }
            /*else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_ARDRONE3_PILOTINGSTATE_POSITIONCHANGED) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifySpeedChanged(speedX, speedY, speedZ);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyDroneLocationChanged(new GPSCoordinate(latitude, longitude, altitude), latitudeAccuracy, longitudeAccuracy, altitudeAccuracy);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMaxAltitudeChanged(current, min, max);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMotorErrorChanged(motorIds, motorError);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override public void run() {
                            commandReceivedListener.notifyPictureFormatChanged(type);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override public void run() {
                            commandReceivedListener.notifyWitheBalanceModeChanged(type);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override public void run() {
                            commandReceivedListener.notifyPictureIntervalChanged(BooleanExtension.parse(enabled), interval, minInterval, maxInterval);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyHomeLocationChanged(BooleanExtension.parse(isFixed));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMotorFlightStatusChanged(numberOfFlights, lastFlightDuration, totalFlightDuration);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyLastMotorErrorChanged(motorError);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyGeofencingChanged(BooleanExtension.parse(shouldNotFlyOver));
                        }
                    });
                }
            }
            /*
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyAltitudeChanged(altitude);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyHomeLocationChanged(new GPSCoordinate(latitude, longitude, altitude));
                        }
                    });
                }
            }
                ...
                while (itr.hasNext()) {
                    ...
                    if (args != null) {
                        ...
                        mHandler.post(new Runnable() {
                            @Override
                            public void run() {
                                commandReceivedListener.notifyFlightPlanComponentStateListChanged(component, BooleanExtension.parse(state));
                            }
                        });
                    }
                }
            ...
            /*else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_COMMON_FLIGHTPLANEVENT_STARTINGERROREVENT) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyFlightPlanAvailabilityStateChanged(BooleanExtension.parse(availabilityState));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            commandReceivedListener.notifyAutonomousFlightChanged(state, type, filepath);
                        }
                    });
                }
            }
            /*else if ((commandKey == ARCONTROLLER_DICTIONARY_KEY_ENUM.ARCONTROLLER_DICTIONARY_KEY_COMMON_MAVLINKSTATE_MAVLINKPLAYERRORSTATECHANGED) && (elementDictionary != null)){
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCalibrationRequiredChanged(BooleanExtension.parse(required));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCalibrationAxisChanged(axis);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCalibrationStateChanged(BooleanExtension.parse(started));
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyCalibrationAxisStateChanged(BooleanExtension.parse(xAxisIsCalibrated),
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyMissionItemExecutedChanged(missionItemId);
                        }
                    });
                }
            }
                ...
                if (args != null) {
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            commandReceivedListener.notifyNumberOfSatellitesChanged(gpsSatellites);  // show value in TextView
                        }
                    });
                }
            }
