...
public interface DroneDeviceOnCommandReceivedListener {
    ...
    void notifyWitheBalanceModeChanged(ARCOMMANDS_ARDRONE3_PICTURESETTINGSSTATE_AUTOWHITEBALANCECHANGED_TYPE_ENUM type);
